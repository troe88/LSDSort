...
public class NegHundredThousandTest extends TestCase {
	/**
	 ...
	 */
	public NegHundredThousandTest(String testName) {
		super(testName);
	}
	...
	public static Test suite() {
		return new TestSuite(NegHundredThousandTest.class);
	}
	...
	public void testApp() {
		...
		epam.course.LSD.LSD.genRandArray(in, true);
